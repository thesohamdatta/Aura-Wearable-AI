...
app.include_router(oauth.router)  # Added oauth router (for Aura Apps)
app.include_router(auth.router)  # Added auth router (for the main Aura App, this is the core auth router)
