...
<Steps>
  <Step title="User Initiates Recording" icon="microphone">
    The user starts a recording session using the Aura app, capturing a conversation or their thoughts.
  </Step>
  <Step title="WebSocket Connection" icon="plug">
    The Aura app establishes a real-time connection with the backend at the `/v4/listen` endpoint in `routers/transcribe.py`.
  </Step>
...
<CardGroup cols={2}>
  <Card title="GitHub Issues" icon="github" href="https://github.com/BasedHardware/aura/issues">
    Report bugs or request features
  </Card>
  <Card title="Discord Community" icon="discord" href="http://discord.aura.me">
    Get help from the community
  </Card>
  <Card title="Contribution Guide" icon="code-branch" href="https://docs.aura.me/developer/Contribution/">
