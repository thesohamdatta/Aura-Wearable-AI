...
<Info>
If you just want to build apps or test features, you can use Aura's development backend instead. See the [App Setup Guide](/doc/developer/AppSetup) for the automatic setup option.
</Info>
