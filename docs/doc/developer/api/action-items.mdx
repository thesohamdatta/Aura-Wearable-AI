...
<Tip>
Push notifications are automatically sent to the Aura app if a `due_at` date is provided.
</Tip>
...
<Tip>
When updating `due_at`, a push notification is sent to the Aura app to remind the user.
</Tip>
