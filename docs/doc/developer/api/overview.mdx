...
<Tip>
If a key is compromised, revoke it immediately from **Settings → Developer** in the Aura app.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Chat Tools" icon="wrench" href="/doc/developer/apps/ChatTools">
    **For App Developers** - Add custom tools that Aura's AI can invoke during conversations
  </Card>
