...
<Tip>
Check out the [Notion CRM Example](https://github.com/BasedHardware/Aura/blob/main/plugins/example/main.py) for a complete implementation.
</Tip>
...
<Tip>
See the [Real-time News Checker Example](https://github.com/BasedHardware/aura/blob/main/plugins/example/advanced/realtime.py) for a complete implementation.
</Tip>
...
<Tip>
Use [webhook.site](https://webhook.site) to see exactly what data Aura sends before writing any code.
</Tip>
...
<Info>
When users open your setup links, Aura automatically appends a `uid` query parameter. Use this to associate credentials with specific users.
</Info>
