...
<CardGroup cols={2}>
  <Card title="Install App" icon="download" href="https://h.aura.me/apps/01K7BHKJR79KQQW7ZZGZX7GCGD">
    Install the GitHub Issues app from the Aura App Store
  </Card>
  <Card title="View Code" icon="code" href="https://github.com/aaravgarg/aura-github-app">
...
<Steps>
  <Step title="Install the App">
    Install the [GitHub Issues app](https://h.aura.me/apps/01K7BHKJR79KQQW7ZZGZX7GCGD) in your AURA mobile app
  </Step>
...
<CardGroup cols={3}>
  ...
  <Card title="Source Code" icon="code" href="https://github.com/aaravgarg/aura-github-app">
