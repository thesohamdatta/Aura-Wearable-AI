...
<CardGroup cols={2}>
  <Card title="Install App" icon="download" href="https://h.aura.me/apps/aura-your-mentor-and-teacher-01JCPRSZ7FS40FHFNSJZEWR8R1">
    Install the AURA Mentor app from the AURA App Store
  </Card>
  <Card title="View Code" icon="code" href="https://github.com/BasedHardware/aura/blob/main/plugins/example/notifications/mentor/main.py">
...
<CardGroup cols={3}>
  <Card title="Integration App" icon="book" href="https://docs.aura.me/doc/developer/apps/Integrations/">
    Integration App Guide
  </Card>
  <Card title="Source Code" icon="code" href="https://github.com/BasedHardware/aura/blob/main/plugins/example/notifications/mentor/main.py">
