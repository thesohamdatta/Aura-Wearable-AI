...
<CardGroup cols={2}>
  <Card title="Install App" icon="download" href="https://h.aura.me/apps/SLACK_APP_ID">
    Install the Slack app from the AURA App Store
  </Card>
  <Card title="View Code" icon="code" href="https://github.com/BasedHardware/aura-slack-app">
...
<CardGroup cols={3}>
  ...
  <Card title="Source Code" icon="code" href="https://github.com/BasedHardware/aura-slack-app">
