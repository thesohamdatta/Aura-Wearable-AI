...
<Steps>
  ...
  <Step title="User Sees Result">
    Aura displays your response to the user
  </Step>
</Steps>
...
<Note>
**Endpoint URLs in Manifest**: You can use relative paths (e.g., `/api/send_message`) in your manifest. Aura will automatically resolve them using your `App Home URL` as the base URL.
</Note>
